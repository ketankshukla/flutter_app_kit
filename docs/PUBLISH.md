...
End-to-end checklist for getting `flutter_app_kit` (or any app cloned from it) live on the Play Store. Assumes `docs/SETUP.md` is done.
...
- `applicationId` in `android/app/build.gradle` → e.g. `com.ketankshukla.flutter_app_kit`
