...
1. Go to https://console.firebase.google.com → **Add project** → name it `flutter-app-kit` (or your app name) → enable Google Analytics.
...
3. Add an **Android app** → bundle ID = `com.ketankshukla.flutter_app_kit`. RevenueCat will ask for a Google Play service-account credential — set this up later before launch (see PUBLISH.md step 5).
